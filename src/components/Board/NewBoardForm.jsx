...
function NewBoardForm() {
  ...
  return (
    <div className="flex flex-col mt-5 bg-gray-200 rounded-xl h-fit  shadow-lg">
      <header className="relative  bg-primary dark:bg-gray-700 rounded-t-xl w-full h-11 text-center py-2 ">
      ...
      <form
        className="flex flex-col gap-5 rounded-b-lg p-5 dark:bg-gray-600"
        onSubmit={handelSubmit}
      >
        <div className="flex items-center gap-3">
          <label htmlFor="boardName" className="font-semibold dark:text-white">
            Board Name:
          </label>
          <input
            type="text"
            ...
            className="px-3 py-1 bg-white  dark:text-white rounded-lg placeholder:text-sm placeholder:text-gray-500 focus:outline-none dark:bg-gray-400 dark:placeholder:text-white"
